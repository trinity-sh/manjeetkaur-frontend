                ...
                <div className="main-container">
                    <div className="details">
                        ...
                        <span className="brief-info">
                            ...
                            believe that by working together, we can create a
                            better future for all. Our work is centered on
                            helping the less fortunate and vulnerable
                            individuals, families, and communities across the
                            globe. In this write-up, we will highlight some of
                            the key areas in which our charity organization
                            operates and the impact of our work.
                        </span>
                    </div>
                    <button className="works-mobile" onClick={toggleWorks}>
                        {showWorks ? "Close Work" : "View Work..."}
                    </button>
                    {showWorks && (
                        <div className="mobile-container">
                            ...
                            <section>
                                {jsonData.map((data, index) => (
                                    <section key={index} className="sideworks">
                    ...
                    <div className="details">
                        <h2 className="info-headers">Areas of Operation:</h2>

                        <span className="brief-info">
                            Our charity organization operates in several areas,
                            including:
                        </span>
                        <p className="brief-points md:px-8">
                            <ul className="marker:text-pink-700 list-disc list-outside">
                                <li>
                                    <strong className="text-pink-700">
                                        Education:
                                    </strong>{" "}
                                    We believe that education is the key to
                                    breaking the cycle of poverty. Our charity
                                    organization provides access to education
                                    for children who are unable to attend school
                                    due to financial constraints. We provide
                                    scholarships, school supplies, and other
                                    essential resources to ensure that these
                                ...
                                <li>
                                    ...
                                    Our charity organization is committed to
                                    improving the health and well-being of
                                    individuals in need. We provide medical
                                    supplies, treatment, and support to those
                                    who are suffering from illnesses such as
                                    malaria, tuberculosis, and HIV/AIDS. We also
                                    work to improve access to clean water and
                                    sanitation to prevent the spread of
                                    diseases.
                                </li>
                                <li>
                                    <strong className="text-pink-700">
                                    ...
                                    Our charity organization is dedicated to
                                    providing food and nutrition to those who
                                    are facing hunger and malnutrition. We
                                    provide food aid, nutrition education, and
                                    support to individuals and families in need.
                                    We also work to promote sustainable
                                    agriculture practices to ensure long-term
                                    food security.
                                </li>
                                <li>
                                    <strong className="text-pink-700">
                                    ...
                                    Our charity organization responds to
                                    emergencies and natural disasters, providing
                                    immediate relief to those affected. We
                    ...
                    <div className="details">
                        <h2 className="info-headers">Impact of Our Work:</h2>
                        <span className="brief-info">
                            Our charity organization has made a significant
                            impact in the lives of those we serve. Through our
                            education programs, we have helped children achieve
                            their academic potential and break the cycle of
                            poverty. We have also improved access to healthcare,
                            providing treatment and support to those who are
                            suffering from illnesses. Our food and nutrition
                            programs have helped to reduce hunger and
                            malnutrition in communities around the world. In
                            times of emergencies and natural disasters, our
                            organization has responded quickly, providing
                            essential relief to those affected. We have helped
                            to provide shelter, food, and medical care to those
                            who have been displaced or injured. Our charity
                            organization is committed to making a positive
                            impact on the lives of those in need. We believe
                            that by working together, we can create a better
                            future for all. Our work in education, health, food
                            and nutrition, and emergency relief has made a
                            significant difference in the lives of those we
                            serve. We will continue to work tirelessly to
                            improve the lives of vulnerable individuals,
                        ...
                        {jsonData.map((data, index) => (
                            <section key={index} className="sideworks">
                                <div>
                                    <img src={data.img} alt="img" />
                                    <p>{data.p}</p>
                                    <a className="read-more" href={data.link}>
                                        View our Work...
                                    </a>
                                </div>
                            </section>
